  ...
  return (
    <StyledBlog>
      ...
      <p>
        ...
        information more efficiently, thuse improving using experience. There
        are couple of ways to present content, UI/UX designers need to choose
        them wisely and accordingly.
      </p>
      <SubTitle>
        <strong>Table</strong>
      </SubTitle>
      ...
      <p>
        ...
        content to show while <strong>maintaining tidiness</strong> of the
        interface is still being considered.
      </p>
      <SubTitle>
      ...
      <p>
        ...
        <strong>website homepage</strong>. Keep in mind it is proper to have
        around 3-5 slides in a carousel, and we need to give hints to users on
        number of slides and the direction it is sliding towards.
      </p>
      <SubTitle>
        <strong>Card</strong>
      </SubTitle>
      ...
      <p>
        Card is a content container that does not have too much restrictions on
        type of content being held. It gives users a 'blocky' feeling, which
        means that it makes{' '}
        <strong>content of the same type more concentrated</strong>, thus easier
        operations.
      </p>
